	...
	<main class="container edit_main">
		<div class="edit_content">
			<c:if test="${not empty edit}">
				<div class="edid_action_area">
					<div class="edid_action_text">${edit.action}</div>
				</div>
			</c:if>
			<form method="post" class="edit_form"
				action="<c:url value="/pages/user/edit"/>">
				<h3>修改會員資料</h3>
				<table>
					<tr>
				...
				<table>
					<tr>
						...
						<td style="width: 200px;"><input size="25" type="date"
							name="birth"
				...
				<table>
					<tr>
						...
						<td style="width: 200px;"><input type="text" name="phone"
							value="${user.phone}"></td>
